...
<div class="min-h-screen">
    ...
    <section class="bg-white">
        <div class="grid md:grid-cols-2 items-center md:gap-64 gap-16 sm:py-12 lg:py-8 font-[sans-serif] text-[#333] max-w-7xl max-md:max-w-md mx-auto">
            ...
            <h2 class="md:text-4xl text-xl md:leading-10 font-semibold text-black text-start">SPORTS</h2>
            ...
            <div class="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
                <img src="/img/ds/sports.png" alt="" class="object-contain h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
            </div>
        </div>
        <div class="px-40">
    ...
    <section class="bg-[#F5F5F5] text-gray-900">
        <div class="container max-w-xl p-6 py-16 mx-auto space-y-24 lg:px-4 lg:max-w-7xl">         
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">      
                    <div class="col-span-2">
                        ...
                        <div class="w-full px-4 md:order-first text-center md:text-left lg:pr-12">
                            <h1 class="text-3xl font-semibold leadi text-center lg:text-left mt-48 mb-2">FOOTBALL/SOCCER</h1>
                            <button class="w-full border-b-2 border-gray-300 pb-3 text-left group focus:outline-none">
                                <div class="text-md font-semibold text-red-500">Q: What is the airspeed velocity of an unladen swallow?</div>
                                <div class="mt-3 hidden text-gray-700 group-focus:flex">
                                    <p>Ans: Although a definitive answer would of course require further measurements, published species-wide averages of wing length and body mass, initial Strouhal estimates based on those averages and cross-species comparisons, the Lund wind tunnel study of birds flying at a range of speeds, and revised Strouhal numbers based on that study all lead me to estimate that the average cruising airspeed velocity of an unladen European Swallow is roughly 11 meters per second, or 24 miles an hour.</p>
    ...
    <section class="bg-gray-300">
        <div class="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
            <div class="flex flex-col mx-auto lg:flex-row">
                <div class="flex flex-col w-full p-6 lg:w-2/3 md:p-8 lg:p-12 mt-8">
                ...
                <div class="flex flex-col w-full p-6 lg:w-2/6 md:p-8 lg:p-8 mt-12">
                    <h2 class="text-4xl font-semibold leadi text-end">3/100</h2>
                </div>
                <div class="w-full lg:w-1/3">
                    <div id="app"></div>
                </div>
            </div>
            <div class="border-dashed border-2 border-yellow-500 rounded-md px-32 py-16 w-full mx-auto max-w-6xl">
                ...
                <div class="px-5 py-5 flex flex-col justify-between gap-y-5 sm:mt-10 sm:flex-row sm:gap-y-0 sm:gap-x-6">
                    ...
                    <button type="submit" class="w-max rounded-md border-2 border-amber-500 bg-amber-500 px-5 py-1.5 text-sm font-semibold text-white transition-colors duration-150 ease-in-out hover:border-amber-400 hover:bg-amber-400">Next Question</button>            </div>
                </div>
            </div>
        </div>
    </section>
