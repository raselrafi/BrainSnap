...
<div class="min-h-screen">
    ...
    <section class="bg-white">
        <div class="grid md:grid-cols-2 items-center md:gap-64 gap-16 sm:py-12 lg:py-8 font-[sans-serif] text-[#333] max-w-7xl max-md:max-w-md mx-auto">
            ...
            <h2 class="md:text-4xl text-xl md:leading-10 font-semibold text-black mb-2">ABOUT US</h2>
            ...
            <div class="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
                <img src="/img/ds/about.jpeg" alt="" class="object-contain h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
            </div>
        </div>
        <div class="px-40">
    ...
    <section class="bg-[#F3F3F3] dark:text-gray-100">
        <div class="container max-w-xl p-6 py-16 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
            <div class="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                <div>
                    <h3 class="text-xl font-semibold tracki sm:text-4xl dark:text-gray-50">OUR MISSION</h3>
                    <p class="mt-3 text-md dark:text-gray-400 text-justify">At BrainSnap, we are on a mission to make learning an 
                        exhilaratng experience. We believe that acquiring knowledge 
                        should be engaging, accessible, and above all, fun. Our 
                        platorm is designed to spark curiosity, challenge minds, and 
                        foster a love for contnuous learning.</p>
                </div>
                <div aria-hidden="true" class="mt-10 lg:mt-0">
                    <img src="img/assets/Our_Mission.png" alt="" class="mx-auto rounded-lg dark:bg-gray-500">
                </div>
            </div>
            <div>
                <div class="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                    <div class="lg:col-start-2">
                        <h3 class="text-xl font-semibold tracki sm:text-4xl dark:text-gray-50">WHAT SETS US APART</h3>
                        <p class="mt-3 text-md dark:text-gray-400 text-justify">Dynamic Quizzes: Our carefully crafed quizzes cover a spectrum of 
                            topics, ensuring there's something for everyone.
                            Instant Brilliance: Experience the thrill of instant cognitve 
                            satsfacton with our quick and insightul quizzes.
                            Community of Learners: Join a vibrant community of knowledge 
                            enthusiasts, where sharing ideas and learning together is at the 
                            heart of what we do.</p>
                    </div>
                    <div class="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
                        <img src="img/assets/Our_Mission2.png" alt="" class="mx-auto rounded-lg dark:bg-gray-500">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-[#F3F3F3] px-2 py-6">
        <div id="features" class="mx-auto max-w-7xl p-6 mb-10">
            <div class="border-b border-opacity-100 border-yellow-400">
                <p class="text-end text-2xl font-semibold leading-7 text-amber-500">Did you know?</p>
                <h2 class="text-end font-display text-xl font-semibold tracking-tight text-slate-900 md:text-3xl">
                    The earliest literary text in Bengali is the
                </h2>
                <h2 class="text-end font-display text-3xl font-semibold tracking-tight text-slate-900 md:text-3xl">
                    8th century Charyapada.
                </h2>
            </div>
            <div class="mt-2 mb-10">
                <h2 class="mt-3 text-start font-display text-2xl font-semibold tracking-tight text-slate-900 md:text-4xl">
                    WHY BRAINSNAP?
                </h2>
            </div>
            <div class="grid lg:grid-cols-3 sm:grid-cols-2 gap-x-6 gap-y-12 max-w-7xl mx-auto">
                <div class="text-center bg-gray-200 p-4 border-b-4 border-amber-500 rounded-md">
                  ...
                  <h3 class="text-xl font-semibold mt-5 text-gray-900">Versatle Practce</h3>
                  <p class="text-gray-800 font-semibold mt-3">Users can practce on a variety of topics with instant feedback.</p>
                </div>
                <div class="text-center bg-gray-200 p-4 border-b-4 border-amber-500 rounded-md">
                  <svg xmlns="http://www.w3.org/2000/svg" class="fill-orange-600 w-10 inline-block" viewBox="0 0 512 512">
                  ...
                  <h3 class="text-xl font-semibold mt-5 text-gray-900">Compettve Challenges</h3>
                  <p class="text-gray-800 font-semibold mt-3">Engage in quiz compettons with tmed 
                      questons and visible scores.</p>
                </div>
                <div class="text-center bg-gray-200 p-4 border-b-4 border-amber-500 rounded-md">
                  ...
                  <h3 class="text-xl font-semibold mt-5 text-gray-900">Collaboratve Team Quizzing</h3>
                  <p class="text-gray-800 font-semibold mt-3">Team members collectvely partcipate in scheduled quizzes.</p>
                </div>
                <div class="text-center bg-gray-200 p-4 border-b-4 border-amber-500 rounded-md">
                  <svg xmlns="http://www.w3.org/2000/svg" class="fill-orange-600 w-10 inline-block" viewBox="0 0 512 512">
                  ...
                  <h3 class="text-xl font-semibold mt-5 text-gray-900">Quiz Master Control</h3>
                  <p class="text-gray-800 font-semibold mt-3">Moderators control quiz sessions, predictng outcomes and managing answers.</p>
                </div>
                <div class="text-center bg-gray-200 p-4 border-b-4 border-amber-500 rounded-md">
                  <svg xmlns="http://www.w3.org/2000/svg" class="fill-orange-600 w-10 inline-block" viewBox="0 0 28 28">
                    <path d="M18.56 16.94h-3.12l.65-2.16a2.58 2.58 0 0 0-1.66-3.21 1.41 1.41 0 0 0-1.81 1l-.1.42a8.61 8.61 0 0 1-2.26 4l-.57.56a1.56 1.56 0 0 0-1.21-.59h-.73a1.56 1.56 0 0 0-1.56 1.54v6.44a1.56 1.56 0 0 0 1.56 1.56h.73a1.55 1.55 0 0 0 1.33-.76l.14.07a6.55 6.55 0 0 0 2.91.69h3.59a3.58 3.58 0 0 0 3-1.6 6.34 6.34 0 0 0 1.07-3.53v-2.49a1.94 1.94 0 0 0-1.96-1.94zm-9.56 8a.56.56 0 0 1-.56.56h-.69a.56.56 0 0 1-.56-.56V18.5a.56.56 0 0 1 .56-.56h.73a.56.56 0 0 1 .52.56zm10.5-3.57a5.38 5.38 0 0 1-.9 3 2.59 2.59 0 0 1-2.15 1.15h-3.59a5.53 5.53 0 0 1-2.46-.58l-.4-.2V18.6l.92-.92a9.63 9.63 0 0 0 2.53-4.46l.1-.41a.43.43 0 0 1 .2-.26.4.4 0 0 1 .32 0 1.58 1.58 0 0 1 1 2l-.84 2.81a.5.5 0 0 0 .08.44.48.48 0 0 0 .4.2h3.79a.94.94 0 0 1 .94.94zM11 7.3l-.32 1.85a1.09 1.09 0 0 0 .44 1.09 1.11 1.11 0 0 0 .65.22 1.18 1.18 0 0 0 .52-.13L14 9.45l1.67.88a1.1 1.1 0 0 0 1.17-.09 1.09 1.09 0 0 0 .44-1.08L17 7.3 18.31 6a1.1 1.1 0 0 0 .29-1.14 1.12 1.12 0 0 0-.9-.76l-1.87-.27L15 2.12a1.12 1.12 0 0 0-2 0l-.83 1.69-1.87.27a1.12 1.12 0 0 0-.9.76A1.1 1.1 0 0 0 9.69 6zm-.6-2.23 2.13-.31a.49.49 0 0 0 .47-.27l1-1.93a.11.11 0 0 1 .2 0l1 1.93a.49.49 0 0 0 .38.27l2.13.31a.12.12 0 0 1 .09.08.11.11 0 0 1 0 .11l-1.54 1.5a.53.53 0 0 0-.15.45l.37 2.11a.09.09 0 0 1-.05.11.1.1 0 0 1-.12 0l-1.9-1a.47.47 0 0 0-.46 0l-1.91 1a.09.09 0 0 1-.11 0 .09.09 0 0 1-.05-.11l.37-2.11a.53.53 0 0 0-.15-.45l-1.54-1.5a.11.11 0 0 1 0-.11.12.12 0 0 1-.12-.08zm-3.06 8.18a1 1 0 0 0 1-1.19l-.27-1.52 1.12-1.09a1 1 0 0 0-.56-1.73L7.1 7.5l-.69-1.39a1.05 1.05 0 0 0-1.82 0L3.9 7.5l-1.53.22a1 1 0 0 0-.56 1.73l1.11 1.09-.27 1.52a1 1 0 0 0 .41 1 1 1 0 0 0 1.07.07l1.37-.72 1.37.72a1 1 0 0 0 .47.12zm-1.84-1.9a.46.46 0 0 0-.23.06l-1.63.82.36-1.78a.53.53 0 0 0-.2-.45L2.51 8.71l1.8-.26a.47.47 0 0 0 .37-.27l.83-1.63.81 1.63a.47.47 0 0 0 .37.27l1.8.29L7.2 10a.53.53 0 0 0-.15.45l.29 1.8-1.61-.84a.46.46 0 0 0-.23-.06zm20.95-2.94a1 1 0 0 0-.82-.69L24.1 7.5l-.69-1.39a1.05 1.05 0 0 0-1.82 0L20.9 7.5l-1.53.22a1 1 0 0 0-.56 1.73l1.11 1.09-.27 1.52a1 1 0 0 0 .41 1 1 1 0 0 0 1.07.07l1.37-.72 1.37.72a1 1 0 0 0 .47.12 1 1 0 0 0 1-1.19l-.27-1.52 1.11-1.09a1 1 0 0 0 .27-1.04zM24.2 10a.53.53 0 0 0-.15.45l.29 1.8-1.61-.84a.47.47 0 0 0-.46 0l-1.63.82.36-1.78a.53.53 0 0 0-.2-.45l-1.29-1.29 1.8-.26a.47.47 0 0 0 .37-.27l.83-1.63.81 1.63a.47.47 0 0 0 .37.27l1.8.29z" data-name="Layer 2" data-original="#000000" />
                  </svg>
                  <h3 class="text-xl font-semibold mt-5 text-gray-900">Comprehensive Engagement</h3>
                  <p class="text-gray-800 font-semibold mt-3">Diverse modes for practce, competton, and collaboraton with real-tme insights.</p>
                </div>
          </div>
        </div>
    <div>    
    ...
    <section class="bg-[#F3F3F3]">
        <div class="text-center max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-2 lg:max-w-7xl">
            <div class="flex flex-wrap items-center mt-10 text-left text-center">
                <div class="w-full md:w-3/5 lg:w-1/2">
                    <img src="img/assets/Join.png" alt="bulk editing" class="inline-block">
                </div>
                <div class="w-full md:w-2/5 lg:w-1/2 px-4 md:order-first text-center md:text-left lg:pr-2">
                    <h3 class="font-semibold mt-8 text-xl md:mt-0 sm:text-4xl">
                        JOIN THE BRAINSNAP COMMUNITY
                    </h3>
                    <p class="sm:text-base mt-4 mr-16">
                        Whether you're a student prepping for exams, a professional 
                        looking to stay sharp, or simply someone who loves a good 
                        quiz, BrainSnap is your go-to quiz destnaton.
                    </p>
